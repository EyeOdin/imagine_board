...
class ImagineBoard_Docker( DockWidget ):
    ...
    def Widget_Adjust( self, icon, widget_x, widget_y, numbers ):
        # Icons
    ...
    def Index_Enable( self, boolean ):
        ...
        if self.slideshow_play == False:
            ...
            self.layout.index_number.setEnabled( boolean )
        # Mode
        self.layout.index_number.setValue( self.preview_index )
        self.layout.index_number.setSuffix( ":" + str( self.preview_max ) )
