...
class ImagineBoard_Docker(DockWidget):
    ...
    def Modules(self):
        ...
        self.colorpicker_widget.setWindowFlags(
    ...
    def Update_Size(self):
        ...
        if check == True:
            ...
            self.imagine_database.Set_Size_Corner(self.layout.database_view.width(), self.layout.database_view.height())
            ...
            self.imagine_database.Set_Size_Middle(self.layout.database_view.width(), self.layout.database_view.height())
