...
class ImagineBoard_Docker(DockWidget):
    ...
    def Style(self):
        ...
        self.dialog.group_a_directory.setStyleSheet("#group_a_directory{background-color: rgba(0, 0, 0, 10);}")
        self.dialog.group_b_preview.setStyleSheet("#group_b_preview{background-color: rgba(0, 0, 0, 10);}")
        self.dialog.group_c_grid.setStyleSheet("#group_c_grid{background-color: rgba(0, 0, 0, 10);}")
    ...
    def Thumbnail_Start(self, SIGNAL_LOAD):
        ...
        self.thread_thumbnails.Variables(os.path.basename(self.directory_path), self.found_path, self.preview_max, limit_l, limit_r)
