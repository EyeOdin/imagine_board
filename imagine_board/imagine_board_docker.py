...
imagine_board_version = "2023_03_29"
...
class ImagineBoard_Docker(DockWidget):
    ...
    def User_Interface(self):
        ...
        os.mkdir( self.image_path, 0o666 )
    ...
    def Menu_Mode_Press(self, event):
        ...
        # cmenu_database = cmenu.addAction("Database")
        # Icons
    ...
    def Update_Size(self):
        ...
        if check == True:
            ...
            # self.imagine_database.Set_Size_Corner(self.layout.imagine_database.width(), self.layout.imagine_database.height())
            ...
            # self.imagine_database.Set_Size_Middle(self.layout.imagine_database.width(), self.layout.imagine_database.height())
    ...
    def Window_Closed(self):
        # self.imagine_database.Database_Disconnect()
        pass
