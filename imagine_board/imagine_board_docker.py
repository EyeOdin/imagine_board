...
class ImagineBoard_Docker(DockWidget):
    ...
    def Connections(self):
        ...
        # Dialog Information
        self.dialog.info_title.returnPressed.connect(self.Information_Save)
        self.dialog.info_subject.returnPressed.connect(self.Information_Save)
        self.dialog.info_keyword.returnPressed.connect(self.Information_Save)
        self.dialog.info_license.returnPressed.connect(self.Information_Save)
        self.dialog.info_description.textChanged.connect(self.Information_Save)
        self.dialog.info_abstract.returnPressed.connect(self.Information_Save)
    ...
    def Information_Read(self):
        ...
        self.dialog.info_description.setText(self.info.get("abstract")) # is Description is officially kept inside ABSTRACT tag because Linux
        self.dialog.info_abstract.setText(self.info.get("description")) # is Abstract by consequence
    ...
    def Information_Save(self):
        ...
        if ((self.canvas() is not None) and (self.canvas().view() is not None)):
            ...
            new_description = str(self.dialog.info_abstract.text())
            new_subject = str(self.dialog.info_subject.text())
            new_abstract = str(self.dialog.info_description.toPlainText())
