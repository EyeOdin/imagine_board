...
class ImagineBoard_Docker(DockWidget):
    ...
    def Menu_Mode_Press(self, event):
        ...
        # Icons
        cmenu_preview.setIcon( Krita.instance().icon('folder-pictures') )
        cmenu_grid.setIcon( Krita.instance().icon('gridbrush') )
        cmenu_reference.setIcon( Krita.instance().icon('zoom-fit') )
...
class Thread_Function(QThread):
    """
    Run Function Operation in Batch
    """
