...
class ImagineBoard_Docker( DockWidget ):
    ...
    def User_Interface( self ):
        ...
        # Create Empty folder ( for web save )
    ...
    def Color_Picker( self, SIGNAL_COLOR ):
        ...
        # Display Color
        qcolor = QColor( kac_1*255, kac_2*255, kac_3*255 )
        if self.mode_index == 0:
            self.imagine_preview.Set_Color_Active( press, qcolor )
        if self.mode_index == 1:
            self.imagine_grid.Set_Color_Active( press, qcolor )
        if self.mode_index == 2:
            self.imagine_reference.Set_Color_Active( press, qcolor )

        if press == False:
            self.imagine_preview.Set_Color_Previous( press, qcolor )
            self.imagine_grid.Set_Color_Previous( press, qcolor )
            self.imagine_reference.Set_Color_Previous( press, qcolor )
