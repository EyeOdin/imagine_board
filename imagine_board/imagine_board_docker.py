...
class ImagineBoard_Docker(DockWidget):
    ...
    def Info_Document(self):
        ...
        if ((self.canvas() is not None) and (self.canvas().view() is not None)):
            ...
            t_editing_cycles = self.cycles_to_time(editing_cycles)
            t_editing_time = self.cycles_to_time(editing_time)
            date = self.display_date(date)
            d_creation_date = self.display_date(creation_date)
        ...
        self.dialog.info_list.addItem("Creator       : " + str(initial_creator))
        self.dialog.info_list.addItem("Edit Cycles   : " + str(editing_cycles) + t_editing_cycles)
        self.dialog.info_list.addItem("Edit Time     : " + str(editing_time) + t_editing_time)
        self.dialog.info_list.addItem("Date          : " + str(date))
        self.dialog.info_list.addItem("Creation Date : " + str(d_creation_date) + delta_creation)
        ...
        self.dialog.info_list.addItem("Initials      : " + str(initial))
