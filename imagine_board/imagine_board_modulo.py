...
def event_drop(self, event):
    ...
    if has_html == True:
        ...
        text_list = data_text.split("\n")
        for i in range(0, len(text_list)-1):
            text_list[i] = text_list[i].replace("file:///", "")
        # Construct
    ...
    def Clip_Click(self, event):
        if event.modifiers() == QtCore.Qt.NoModifier:
            ...
            if dist_min < 20:
                ...
                QtCore.qDebug("self.clip_index = " + str(self.clip_index))
            # Lists
    ...
    def paintEvent(self, event):
        ...
        if len(optimized) > 0:
            ...
            if (min_x > self.widget_width or max_x < 0 or min_y > self.widget_height or max_y < 0):
                ...
                painter.drawEllipse(self.w2-2, self.h2-2, 4, 4)
