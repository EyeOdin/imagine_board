...
class ImagineBoard_Reference(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for i in range(0, len(self.list_paths)):
            qpixmap = QPixmap(self.list_paths[i]).scaled(200, 200, Qt.KeepAspectRatio, Qt.FastTransformation)
            painter.drawPixmap( i*100, i*100, qpixmap )
