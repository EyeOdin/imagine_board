...
class ImagineBoard_Reference(QWidget):
    ...
    def contextMenuEvent(self, event):
        if event.modifiers() == QtCore.Qt.NoModifier:
            ...
            if self.pin_zoom[0] == True:
                # Actions
                cmenu_pin_zoom_close = cmenu.addAction("Pin Zoom Close")
                action = cmenu.exec_(self.mapToGlobal(event.pos()))
                # Triggers
                if action == cmenu_pin_zoom_close:
                    self.Pin_Zoom(False, "")
            else:
                if self.index == None:
                    # Actions
                    ...
                    if sel_len > 1:
                        ...
                        # Actions
                        cmenu_pin_zoom_open = cmenu.addAction("Pin Zoom Open")
    ...
    def paintEvent(self, event):
        ...
        if self.pin_zoom[0] == True:
            ...
            if qpixmap.isNull() == False:
                ...
                painter.drawPixmap(0, 0, qpixmap_scaled)
